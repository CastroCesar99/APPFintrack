(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_dc6829ba._.js", {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$theme$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/context/theme-context.tsx [app-client] (ecmascript)"); // Import useTheme
;
...
const formSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
    ...
    installments: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].coerce.number().int().min(1, "Installments must be at least 1 if selected.").optional(),
...
function TransactionForm({ onAddTransaction, initialType, defaultDate, userCategories, userPaymentMethods }) {
    ...
    const [selectedExpenseType, setSelectedExpenseType] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(undefined);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TransactionForm.useEffect": ()=>{
            ...
            const relevantUserCategories = userCategories.filter({
...
_s(TransactionForm, "KLwCp8BRg/1dWxKLcDgkXYWIl5M=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$language$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLanguage"],
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$icons$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/components/icons.tsx [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/utils.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/date-fns/format.mjs [app-client] (ecmascript) <locals>"); // Import parse for YYYY-MM-DD
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                    ...
                    children: transactions.map((transaction)=>{
                        ...
                        try {
                            ...
                            const parsedDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parse$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["parse"])(transaction.date, "yyyy-MM-dd", new Date());
...
function DashboardPage() {
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (preferencesDocSnap.exists()) {
                                ...
                                const customCategoryMap = new Map(customCategoryDefs.map({
                                    "DashboardPage.useEffect.fetchDataInternal": (cd)=>[
                                            cd.name,
                                            cd
                                        ]
                                }["DashboardPage.useEffect.fetchDataInternal"]));
                                const effectiveCategories = [];
                                selectedCategoryNames.forEach({
                                    "DashboardPage.useEffect.fetchDataInternal": (name)=>{
                                        const predefinedCat = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CATEGORIES"].find({
                                            "DashboardPage.useEffect.fetchDataInternal.predefinedCat": (pCat)=>pCat.name === name
                                        }["DashboardPage.useEffect.fetchDataInternal.predefinedCat"]);
                                        if (predefinedCat) {
                                ...
                                if (effectiveCategories.length === 0 && __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CATEGORIES"].length > 0) {
                                    effectiveCategories.push(...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CATEGORIES"].filter({
                                        "DashboardPage.useEffect.fetchDataInternal": (c)=>c.type === 'expense'
                                    }["DashboardPage.useEffect.fetchDataInternal"]), ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CATEGORIES"].filter({
                                        "DashboardPage.useEffect.fetchDataInternal": (c)=>c.type === 'income'
                                    }["DashboardPage.useEffect.fetchDataInternal"]));
                                }
                                ...
                                const customPaymentMethodMap = new Map(customPaymentMethodDefs.map({
                                    "DashboardPage.useEffect.fetchDataInternal": (pm)=>[
                                            pm.name,
                                            pm
                                        ]
                                }["DashboardPage.useEffect.fetchDataInternal"]));
                                const effectivePaymentMethods = [];
                                selectedPaymentMethodNames.forEach({
                                    "DashboardPage.useEffect.fetchDataInternal": (name)=>{
                                        const predefinedPM = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PAYMENT_METHODS"].find({
                                            "DashboardPage.useEffect.fetchDataInternal.predefinedPM": (pPM)=>pPM.name === name
                                        }["DashboardPage.useEffect.fetchDataInternal.predefinedPM"]);
                                        if (predefinedPM) {
                                ...
                                if (effectivePaymentMethods.length === 0 && __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PAYMENT_METHODS"].length > 0) {
                                    effectivePaymentMethods.push(...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PAYMENT_METHODS"]);
                                }
                                if (effectMountedRef.current) {
    ...
    const recentIncome = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[recentIncome]": ()=>{
            const targetYear = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$getYear$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getYear"])(displayedDate);
            const targetMonth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$getMonth$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMonth"])(displayedDate);
            ...
            transactions.forEach({
                "DashboardPage.useMemo[recentIncome]": (t)=>{
            ...
            const sorted = monthlyDisplayTransactions.sort({
                "DashboardPage.useMemo[recentIncome].sorted": (a, b)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parse$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["parse"])(b.date, "yyyy-MM-dd", new Date(0)).getTime() - (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parse$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["parse"])(a.date, "yyyy-MM-dd", new Date(0)).getTime()
            }["DashboardPage.useMemo[recentIncome].sorted"]);
    ...
    const recentExpenses = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[recentExpenses]": ()=>{
            const targetYear = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$getYear$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getYear"])(displayedDate);
            const targetMonth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$getMonth$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMonth"])(displayedDate);
            const targetMonthStart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfMonth$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startOfMonth"])(displayedDate);
            const monthlyDisplayTransactions = [];
            ...
            transactions.forEach({
                "DashboardPage.useMemo[recentExpenses]": (t)=>{
                    if (t.type !== 'expense') return;
                    const originalTransactionDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parse$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["parse"])(t.date, "yyyy-MM-dd", new Date(0));
                    const originalTransactionDay = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$getDate$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDate"])(originalTransactionDate);
                    if (t.expenseType === 'installment' && t.installments && t.installments > 0) {
                        const installmentSeriesStartDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfMonth$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startOfMonth"])(originalTransactionDate);
                        const currentInstallmentNum = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$differenceInCalendarMonths$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["differenceInCalendarMonths"])(targetMonthStart, installmentSeriesStartDate) + 1;
            ...
            const sorted = monthlyDisplayTransactions.sort({
                "DashboardPage.useMemo[recentExpenses].sorted": (a, b)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parse$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["parse"])(b.date, "yyyy-MM-dd", new Date(0)).getTime() - (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parse$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["parse"])(a.date, "yyyy-MM-dd", new Date(0)).getTime()
            }["DashboardPage.useMemo[recentExpenses].sorted"]);
    ...
    const largestExpenseCategoryForDisplayedPeriod = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[largestExpenseCategoryForDisplayedPeriod]": ()=>{
            ...
            if (largestCategoryKey) {
                const predefinedCat = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CATEGORIES"].find({
                    "DashboardPage.useMemo[largestExpenseCategoryForDisplayedPeriod].predefinedCat": (cat)=>cat.name === largestCategoryKey
                }["DashboardPage.useMemo[largestExpenseCategoryForDisplayedPeriod].predefinedCat"]);
                if (predefinedCat) {
                    return {
                    ...
                    const customCat = userCategories.find({
                        "DashboardPage.useMemo[largestExpenseCategoryForDisplayedPeriod].customCat": (cat)=>cat.name === largestCategoryKey && cat.type === 'expense'
                    }["DashboardPage.useMemo[largestExpenseCategoryForDisplayedPeriod].customCat"]);
                    if (customCat) {
                        return {
                            name: largestCategoryKey,
                            amount: maxAmount,
...
_s(DashboardPage, "FFt1ivG/zqeqBPPtnzZO+Tf7b3U=", false, function() {
    return [
...
//# sourceMappingURL=src_dc6829ba._.js.map