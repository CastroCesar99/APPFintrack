...
function AppSidebarContent() {
    ...
    const { language, setLanguage, translate } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$language$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLanguage"])(); // setLanguage might be unused here now
...
_s(AppSidebarContent, "/oV/6MJmV+VrjbbcWst/SO3NHZM=", false, function() {
    return [
...
const formSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
    ...
    amount: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].string().refine((val)=>val === "" || /^[0-9]*[.,]?[0-9]+$/.test(val), {
    ...
    installments: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].string().transform((val)=>val === "" ? undefined : parseInt(val, 10)).refine((val)=>val === undefined || Number.isInteger(val) && val >= 1, {
...
function TransactionForm({ onSave, initialType, defaultDate, userCategories = [], userPaymentMethods = [], transactionToEdit = null }) {
    ...
    const [selectedExpenseType, setSelectedExpenseType] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(transactionToEdit?.expenseType);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TransactionForm.useEffect": ()=>{
            ...
            console.log(`TransactionForm TRACER --- relevantUserCategories length: ${relevantUserCategories.length} Based on initialType: '${initialType}' Content:`, JSON.stringify(relevantUserCategories.map({
...
_s(TransactionForm, "xK+8AyU1ksh/k+hlPWjk+CGIngY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$language$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLanguage"],
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$icons$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/src/components/icons.tsx [app-client] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$icons$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/components/icons.tsx [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$package$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Package$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/package.js [app-client] (ecmascript) <export default as Package>"); // Corrected imports
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$wallet$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Wallet$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/wallet.js [app-client] (ecmascript) <export default as Wallet>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$date$2d$navigation$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/context/date-navigation-context.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$language$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/context/language-context.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/date-fns/format.mjs [app-client] (ecmascript) <locals>");
...
function DashboardPage() {
            ...
            unsubscribePreferencesRef.current = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(preferencesDocRef, {
                "DashboardPage.useEffect": (docSnap)=>{
                    ...
                    if (docSnap.exists()) {
                        ...
                        const customCategoriesWithType = customCategoryDefs.map({
                            "DashboardPage.useEffect.customCategoriesWithType": (c)=>({
                                    ...c,
                                    type: c.type || 'expense',
                                    label: c.label || {
                                        en: c.name,
                        ...
                        }["DashboardPage.useEffect.customCategoriesWithType"]);
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CATEGORIES"].forEach({
                            "DashboardPage.useEffect": (cat)=>combinedCategoriesMap.set(cat.name.toLowerCase(), cat)
                        }["DashboardPage.useEffect"]); // Add all predefined
                        customCategoriesWithType.forEach({
                            "DashboardPage.useEffect": (customCat)=>combinedCategoriesMap.set(customCat.name.toLowerCase(), customCat)
                        }["DashboardPage.useEffect"]); // Add/overwrite with custom
                        ...
                        const customMethodsAsDisplay = customPaymentMethodDefs.map({
                            "DashboardPage.useEffect.customMethodsAsDisplay": (customPm)=>({
                                    ...customPm,
                        ...
                        }["DashboardPage.useEffect.customMethodsAsDisplay"]);
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PAYMENT_METHODS"].forEach({
                            "DashboardPage.useEffect": (pm)=>combinedPaymentMethodsMap.set(pm.name.toLowerCase(), pm)
                        }["DashboardPage.useEffect"]);
                        customMethodsAsDisplay.forEach({
                            "DashboardPage.useEffect": (customPm)=>combinedPaymentMethodsMap.set(customPm.name.toLowerCase(), customPm)
                        }["DashboardPage.useEffect"]);
                        const selectedPaymentMethodNames = preferencesData.selectedPaymentMethods || [];
                        if (selectedPaymentMethodNames.length > 0) {
                            const effectivePMs = Array.from(combinedPaymentMethodsMap.values()).filter({
                                "DashboardPage.useEffect.effectivePMs": (pm)=>selectedPaymentMethodNames.some({
                                        "DashboardPage.useEffect.effectivePMs": (name)=>name.toLowerCase() === pm.name.toLowerCase()
                                    }["DashboardPage.useEffect.effectivePMs"])
                            }["DashboardPage.useEffect.effectivePMs"]);
                ...
                "DashboardPage.useEffect": (error)=>{
                    ...
                    if (effectMountedRef.current) {
                        const defaultCatsError = [
                            ...
                            "DashboardPage.useEffect.defaultCatsError": (a, b)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCategoryDisplayLabel"])(a, language).localeCompare((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCategoryDisplayLabel"])(b, language))
                        }["DashboardPage.useEffect.defaultCatsError"]);
                        const defaultPMsError = [
                            ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PAYMENT_METHODS"]
                        ].sort({
                            "DashboardPage.useEffect.defaultPMsError": (a, b)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPaymentMethodDisplayLabel"])(a, language).localeCompare((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPaymentMethodDisplayLabel"])(b, language))
                        }["DashboardPage.useEffect.defaultPMsError"]);
                            ...
                            "DashboardPage.useEffect.fetchDataInternal": (querySnapshot)=>{
                                ...
                                const fetchedTransactions = querySnapshot.docs.map({
                                    "DashboardPage.useEffect.fetchDataInternal.fetchedTransactions": (docSnap)=>{
                                        ...
                                        if (data.date && typeof data.date === 'object' && data.date instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Timestamp"]) {
    ...
    const transactionsForDisplayedPeriod = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[transactionsForDisplayedPeriod]": ()=>{
            console.log("Dashboard: TRACER --- transactionsForDisplayedPeriod: Recalculating for Year:", (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$getYear$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getYear"])(displayedDate), "Month:", (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$getMonth$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMonth"])(displayedDate), "(0-indexed for", displayedMonthYearLabel + "), All transactions count:", transactions.length);
            ...
            transactions.forEach({
                "DashboardPage.useMemo[transactionsForDisplayedPeriod]": (t)=>{
                    ...
                    if (t.type === 'expense' && t.expenseType === 'installment' && t.installments && t.installments > 0) {
                        ...
                        const isInstallmentActiveThisMonth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isWithinInterval$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isWithinInterval"])(firstDayOfTargetMonth, {
                            start: installmentSeriesStartDate,
                            end: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$endOfMonth$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["endOfMonth"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$addMonths$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addMonths"])(installmentSeriesStartDate, t.installments - 1))
                        });
                        console.log(`Dashboard: TRACER --- Tx Filter (Installment Check): ID: ${t.id}, DateStr: ${t.date}, OrigDate: ${originalTransactionDate.toISOString()}, StartSeries: ${installmentSeriesStartDate.toISOString()}, TargetMonthStart: ${firstDayOfTargetMonth.toISOString()}, monthDiff: ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$differenceInCalendarMonths$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["differenceInCalendarMonths"])(firstDayOfTargetMonth, installmentSeriesStartDate)}, installments: ${t.installments}, isActive: ${isInstallmentActiveThisMonth}, isRec: ${t.isRecurring}, expType: ${t.expenseType}`);
                        ...
                        if (t.isRecurring) {
                            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfMonth$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startOfMonth"])(originalTransactionDate) <= firstDayOfTargetMonth) {
                                includeTransaction = true;
                            }
                        } else {
                            if (transactionYear === targetYear && transactionMonth === targetMonth) {
    ...
    const fullRecentIncomeList = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[fullRecentIncomeList]": ()=>{
            ...
            const targetYear = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$getYear$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getYear"])(displayedDate);
            const targetMonth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$getMonth$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMonth"])(displayedDate);
            const targetMonthStart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfMonth$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startOfMonth"])(displayedDate);
            ...
            transactions.forEach({
                "DashboardPage.useMemo[fullRecentIncomeList]": (t)=>{
                    ...
                    if (t.isRecurring) {
                        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfMonth$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startOfMonth"])(originalTransactionDate) <= targetMonthStart) {
                            let projectedDateForMonth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$setDate$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDate"])(targetMonthStart, originalTransactionDay);
                            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$getMonth$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMonth"])(projectedDateForMonth) !== targetMonth) {
                                projectedDateForMonth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$lastDayOfMonth$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["lastDayOfMonth"])(targetMonthStart);
                            }
                            const projectedTx = {
                                ...t,
                                id: `${t.id}_projected_${targetYear}-${String(targetMonth + 1).padStart(2, '0')}`,
                                date: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(projectedDateForMonth, "yyyy-MM-dd"),
                        ...
                        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$getYear$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getYear"])(originalTransactionDate) === targetYear && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$getMonth$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMonth"])(originalTransactionDate) === targetMonth) {
            ...
            transactions.forEach({
                "DashboardPage.useMemo[fullRecentExpensesList]": (t)=>{
                    ...
                    if (t.expenseType === 'installment' && t.installments && t.installments > 0) {
                        const installmentSeriesStartDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfMonth$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startOfMonth"])(originalTransactionDate);
                        const monthDiff = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$differenceInCalendarMonths$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["differenceInCalendarMonths"])(targetMonthStart, installmentSeriesStartDate);
    ...
    const largestExpenseCategoryForDisplayedPeriod = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[largestExpenseCategoryForDisplayedPeriod]": ()=>{
            ...
            if (largestCategoryKey) {
                ...
                }["DashboardPage.useMemo[largestExpenseCategoryForDisplayedPeriod]"]) || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CATEGORIES"].find({
                    "DashboardPage.useMemo[largestExpenseCategoryForDisplayedPeriod]": (cat)=>cat.name === largestCategoryKey
                }["DashboardPage.useMemo[largestExpenseCategoryForDisplayedPeriod]"]);
                return {
...
_s(DashboardPage, "LAdsV4suk6akMFrVS5winosgEMQ=", false, function() {
    return [
