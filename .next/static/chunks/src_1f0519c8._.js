...
function DashboardPage() {
            ...
            unsubscribePreferencesRef.current = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(preferencesDocRef, {
                "DashboardPage.useEffect": (docSnap)=>{
                    ...
                    if (docSnap.exists()) {
                        ...
                        finalCategories = predefinedCategories.filter({
                        ...
                        finalPaymentMethods = predefinedPaymentMethods.filter({
                ...
                const fetchDataInternal = {
                    "DashboardPage.useEffect.fetchDataInternal": async (currentUserId)=>{
                        ...
                        try {
                            ...
                            const q_transactions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])(transactionsColRef); // Order by date on client side later
                                        ...
                                        "DashboardPage.useEffect.fetchDataInternal.fetchedTransactions": (docSnap)=>{
                                            ...
                                            if (!effectiveMonthString && dateString !== "1970-01-01") {
                                                ...
                                                try {
                                                    ...
                                                    effectiveMonthString = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(), "yyyy-MM"); // Final fallback
                                                }
                                            }
                                            return {
                                                ...data,
    ...
    const onAddTransaction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DashboardPage.useCallback[onAddTransaction]": async (newTransactionData)=>{
            ...
            const effectiveMonthForNewTx = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(displayedDate, "yyyy-MM"); // Effective month is the one being VIEWED
...
_s(DashboardPage, "vru/fUERN4t/o541L5y7Ki5k5Fg=", false, function() {
    return [
