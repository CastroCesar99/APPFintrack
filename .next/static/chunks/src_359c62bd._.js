(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_359c62bd._.js", {
...
function IncomePage() {
                ...
                "IncomePage.useEffect": (docSnap)=>{
                    ...
                    if (docSnap.exists()) {
                        ...
                        const deselectedPredefinedCatNames = new Set((prefsData.deselectedPredefinedCategories || []).map({
                            "IncomePage.useEffect": (name)=>name.toLowerCase()
                        }["IncomePage.useEffect"]));
                        predefinedCategoriesMap.forEach({
                            "IncomePage.useEffect": (pCat, pCatNameLower)=>{
                                if (!deselectedPredefinedCatNames.has(pCatNameLower)) {
                                    const customOverride = userDefinedCategoriesFromPrefs.find({
                                        "IncomePage.useEffect.customOverride": (udc)=>udc.name.toLowerCase() === pCatNameLower
                                    }["IncomePage.useEffect.customOverride"]);
                        ...
                        userDefinedCategoriesFromPrefs.forEach({
                            "IncomePage.useEffect": (customCat)=>{
                                if (!finalCategories.some({
                                    "IncomePage.useEffect": (fc)=>fc.name.toLowerCase() === customCat.name.toLowerCase()
                                }["IncomePage.useEffect"])) {
                        ...
                        predefinedPaymentMethodsMap.forEach({
                            "IncomePage.useEffect": (pPm, pPmNameLower)=>{
                                if (!deselectedPredefinedPmNames.has(pPmNameLower)) {
                                    const customOverride = userDefinedPaymentMethodsFromPrefs.find({
                                        "IncomePage.useEffect.customOverride": (udpm)=>udpm.name.toLowerCase() === pPmNameLower
                                    }["IncomePage.useEffect.customOverride"]);
                        ...
                        userDefinedPaymentMethodsFromPrefs.forEach({
                            "IncomePage.useEffect": (customPm)=>{
                                if (!finalPaymentMethods.some({
                                    "IncomePage.useEffect": (fpm)=>fpm.name.toLowerCase() === customPm.name.toLowerCase()
                                }["IncomePage.useEffect"])) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "IncomePage.useEffect": ()=>{
            ...
            const q_transactions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])(transactionsColRef); // No order by date, will be handled by display logic
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(q_transactions, {
                "IncomePage.useEffect.unsubscribe": (querySnapshot)=>{
                    const fetchedTransactions = querySnapshot.docs.map({
                        "IncomePage.useEffect.unsubscribe.fetchedTransactions": (docSnap)=>{
                    ...
                    }["IncomePage.useEffect.unsubscribe.fetchedTransactions"]);
                    setAllTransactions(fetchedTransactions);
                    setIsLoadingTransactions(false);
                }
            }["IncomePage.useEffect.unsubscribe"], {
                "IncomePage.useEffect.unsubscribe": (error)=>{
    ...
    const getCategoryObjectByName = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "IncomePage.useCallback[getCategoryObjectByName]": (name)=>{
            return userCategories.find({
                "IncomePage.useCallback[getCategoryObjectByName]": (cat)=>cat.name.toLowerCase() === name.toLowerCase()
            }["IncomePage.useCallback[getCategoryObjectByName]"]);
        }
    }["IncomePage.useCallback[getCategoryObjectByName]"], [
        userCategories
    ]);
    const incomeForDisplayedPeriod = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "IncomePage.useMemo[incomeForDisplayedPeriod]": ()=>{
            ...
            allTransactions.forEach({
                "IncomePage.useMemo[incomeForDisplayedPeriod]": (t)=>{
            ...
            if (sortOption === 'dateAsc') {
                monthlyDisplayTransactions.sort({
                    "IncomePage.useMemo[incomeForDisplayedPeriod]": (a, b)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parse$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["parse"])(a.date, "yyyy-MM-dd", new Date(0)).getTime() - (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parse$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["parse"])(b.date, "yyyy-MM-dd", new Date(0)).getTime()
                }["IncomePage.useMemo[incomeForDisplayedPeriod]"]);
            } else if (sortOption === 'dateDesc') {
                monthlyDisplayTransactions.sort({
                    "IncomePage.useMemo[incomeForDisplayedPeriod]": (a, b)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parse$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["parse"])(b.date, "yyyy-MM-dd", new Date(0)).getTime() - (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parse$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["parse"])(a.date, "yyyy-MM-dd", new Date(0)).getTime()
                }["IncomePage.useMemo[incomeForDisplayedPeriod]"]);
            } else if (sortOption === 'amountAsc') {
                monthlyDisplayTransactions.sort({
                    "IncomePage.useMemo[incomeForDisplayedPeriod]": (a, b)=>a.amount - b.amount
                }["IncomePage.useMemo[incomeForDisplayedPeriod]"]);
            } else if (sortOption === 'amountDesc') {
                monthlyDisplayTransactions.sort({
                    "IncomePage.useMemo[incomeForDisplayedPeriod]": (a, b)=>b.amount - a.amount
                }["IncomePage.useMemo[incomeForDisplayedPeriod]"]);
            } else if (sortOption === 'categoryAsc') {
                monthlyDisplayTransactions.sort({
                    "IncomePage.useMemo[incomeForDisplayedPeriod]": (a, b)=>{
                ...
                monthlyDisplayTransactions.sort({
                    "IncomePage.useMemo[incomeForDisplayedPeriod]": (a, b)=>a.description.localeCompare(b.description)
                }["IncomePage.useMemo[incomeForDisplayedPeriod]"]);
            }
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                children: isLoadingPage ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    lineNumber: 529,
                                    columnNumber: 15
                                }, this) : incomeForDisplayedPeriod.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "grid grid-cols-1 gap-4",
...
_s(IncomePage, "DC4gRbEsIk+ye+d8B19b+GHAG38=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
...
//# sourceMappingURL=src_359c62bd._.js.map