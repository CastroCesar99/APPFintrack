        ...
        "BudgetsPage.useCallback[fetchPreferencesAndBudgets]": async ()=>{
            ...
            try {
                ...
                if (prefsSnap.exists()) {
                    ...
                    const customMap = new Map(customDefs.map({
                        "BudgetsPage.useCallback[fetchPreferencesAndBudgets]": (cd)=>[
                                cd.name,
                                cd
                            ]
                    }["BudgetsPage.useCallback[fetchPreferencesAndBudgets]"]));
                    selectedNames.forEach({
                        "BudgetsPage.useCallback[fetchPreferencesAndBudgets]": (name)=>{
                            const predefinedCat = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CATEGORIES"].find({
                                "BudgetsPage.useCallback[fetchPreferencesAndBudgets].predefinedCat": (pCat)=>pCat.name === name && pCat.type === 'expense'
                            }["BudgetsPage.useCallback[fetchPreferencesAndBudgets].predefinedCat"]);
                            if (predefinedCat) {
                ...
                toast({
                    ...
                    description: translate({
                        en: "Could not load your category preferences.",
                        pt: "Não foi possível carregar suas preferências de categoria."
                    }),
                    variant: "destructive"
                });
                effectiveCategories = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CATEGORIES"].filter({
            ...
            try {
                ...
                toast({
                    ...
                    description: translate({
                        en: "Could not load your budgets for this month.",
                        pt: "Não foi possível carregar seus orçamentos para este mês."
                    }),
                    variant: "destructive"
                });
                const errorBudgets = {};
    ...
    const handleReplicateToNextMonth = async ()=>{
        ...
        try {
            ...
            const nextMonthLabel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(nextMonthDate, 'MMMM yyyy', {
                locale: translate({
                    en: undefined,
                    pt: __turbopack_context__.r("[project]/node_modules/date-fns/locale/pt-BR.js [app-client] (ecmascript)").default
                }) || __turbopack_context__.r("[project]/node_modules/date-fns/locale/en-US.js [app-client] (ecmascript)").default
            });
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                            ...
                            children: isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "flex items-center space-x-3 rounded-md border p-4 bg-muted/50",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$trending$2d$up$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__TrendingUp$3e$__["TrendingUp"], {
                ...
                isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: translate({
                        en: "No expense categories selected or defined to set budgets for. Please check your onboarding settings.",
                        pt: "Nenhuma categoria de despesa selecionada ou definida para definir orçamentos. Verifique suas configurações de onboarding."
                    })
                }, void 0, false, {
                    fileName: "[project]/src/app/budgets/page.tsx",
                    lineNumber: 340,
...
_s(BudgetsPage, "Jvc1vP1HRyll2S7ESwbdj2k0YIc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$language$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLanguage"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$date$2d$navigation$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDateNavigation"],
