...
function TransactionForm({ onSave, initialType, defaultDate, userCategories = [], userPaymentMethods = [], transactionToEdit = null }) {
    ...
    const form = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hook$2d$form$2f$dist$2f$index$2e$esm$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useForm"])({
        ...
        defaultValues: {
            ...
            isRecurring: transactionToEdit?.isRecurring || (initialType === 'income' ? false : undefined),
    ...
    async function onSubmit(values) {
        ...
        console.log("TransactionForm TRACER --- onSubmit: Values from react-hook-form (before Zod):", values);
        let validatedValues;
        try {
            validatedValues = formSchema.parse(values); // Zod parses and transforms here
        ...
        // These checks are now largely handled by Zod, but can remain as a safeguard
        ...
        if (validatedValues.expenseType === 'installment' && (finalInstallments === undefined || finalInstallments < 1)) {
            form.setError("installments", {
                type: "manual",
                message: "O número de parcelas é obrigatório e deve ser no mínimo 1."
            });
            setIsSubmitting(false);
            return;
        }
        ...
        try {
            ...
            if (initialType === 'expense') {
                if (validatedValues.expenseType === 'recurring') {
                    finalIsRecurringForSave = true;
                } else {
                    finalIsRecurringForSave = false;
                }
            }
            // For income, validatedValues.isRecurring from checkbox is used.
            const transactionData = {
                ...
                installments: initialType === 'expense' && validatedValues.expenseType === 'installment' ? finalInstallments : undefined,
                isRecurring: finalIsRecurringForSave,
                expenseNature: initialType === 'expense' ? validatedValues.expenseNature : undefined,
                expenseType: initialType === 'expense' ? validatedValues.expenseType : undefined
            };
    ...
    console.log('TransactionForm TRACER --- RENDER START. defaultDate for calendar picker:', form.getValues("date")?.toISOString());
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$form$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["FormControl"], {
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Input"], {
                                        ...
                                        onChange: (e)=>{
                                            ...
                                            // Allow numbers, one comma OR period, and up to 2 decimal places.
                                            // Or an empty string to allow clearing the field.
                                            ...
                                            onValueChange: (value)=>{
                                                ...
                                                if (castValue === 'recurring') {
                                                    ...
                                                    if (castValue !== 'installment') {
                                                        form.setValue('installments', ""); // Reset to empty string for Zod
                                                    }
                                                }
                                            },
                                            value: field.value || undefined,
...
function DashboardPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        unsubscribePreferencesRef.current = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["onSnapshot"])(preferencesDocRef, (docSnap)=>{
            ...
            if (docSnap.exists()) {
                ...
                const customCategoriesMap = new Map((prefsData.userDefinedCategories || []).map((cc)=>[
                        cc.name.toLowerCase(),
                        cc
                    ]));
                const deselectedPredefinedCatNames = new Set((prefsData.deselectedPredefinedCategories || []).map((name)=>name.toLowerCase()));
                finalCategories = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CATEGORIES"].filter((pCat)=>!deselectedPredefinedCatNames.has(pCat.name.toLowerCase())).map((pCat)=>{
                ...
                const customPaymentMethodsMap = new Map((prefsData.userDefinedPaymentMethods || []).map((cpm)=>[
                ...
                finalPaymentMethods = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PAYMENT_METHODS"].filter((pPm)=>!deselectedPredefinedPmNames.has(pPm.name.toLowerCase())).map((pPm)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (mainFetchInitiatedForUser.current !== userId || !unsubscribeTransactionsRef.current) {
                    ...
                    unsubscribeTransactionsRef.current = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["onSnapshot"])(q_transactions, (querySnapshot)=>{
                        ...
                        const fetchedTransactions = querySnapshot.docs.map((docSnap)=>{
                            ...
                            if (data.date && typeof data.date === 'object' && data.date instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Timestamp"]) {
                                ...
                                if (/^\d{4}-\d{2}-\d{2}$/.test(data.date)) {} else if (data.date.includes('T')) {
                                    try {
            ...
            if (effectMountedRef.current && !authLoading && userId && !unsubscribeTransactionsRef.current) {
    ...
    const onAddTransaction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (newTransactionData)=>{
        ...
        const transactionDateObject = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parse$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["parse"])(newTransactionData.date, "yyyy-MM-dd", new Date());
    ...
    ]); // displayedMonthYearLabel for logging only
            ...
            if (t.type === 'income') {
                if (t.isRecurring) {
                    ...
                    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfMonth$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["startOfMonth"])(originalTransactionDate) <= firstDayOfDisplayedMonth) {
                        ...
                        console.log(`Dashboard: TRACER --- recentIncome: Added projected recurring: ${t.description}, Orig Date: ${t.date}, Projected Date: ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(projectedDate, "yyyy-MM-dd")}`);
                    }
            ...
            if (t.type === 'expense') {
                if (t.expenseType === 'installment' && t.installments && t.installments > 0) {
                    ...
                    if (currentInstallmentNum >= 1 && currentInstallmentNum <= t.installments) {
                        ...
                        console.log(`Dashboard: TRACER --- recentExpenses: Added projected installment: ${installmentDescription}, Orig Date: ${t.date}, Projected Date: ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(projectedDate, "yyyy-MM-dd")}`);
                    }
                    ...
                    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfMonth$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["startOfMonth"])(originalTransactionDate) <= firstDayOfDisplayedMonth) {
                        ...
                        console.log(`Dashboard: TRACER --- recentExpenses: Added projected recurring: ${t.description}, Orig Date: ${t.date}, Projected Date: ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(projectedDate, "yyyy-MM-dd")}`);
                    }
                } else if ((!t.isRecurring || t.isRecurring === false) && (!t.expenseType || t.expenseType !== 'installment')) {
