...
import { CATEGORIES, getCategoryDisplayLabel, PAYMENT_METHODS, getCategoryLabel } from "@/types";
        ...
        if (docSnap.exists()) {
            ...
            finalCategories = finalCategories.map(pCat => {
                ...
                if (customOverride) {
                    ...
                    return { ...pCat, ...customOverride }; // Merge, custom label/icon takes precedence
                }
                return pCat;
            });
