 ...
 * - CreateUserSubscriptionInputSchema - The Zod schema for the input.
 * - CreateUserSubscriptionOutputSchema - The Zod schema for the output.
...
export const CreateUserSubscriptionInputSchema = z.object({
...
export const CreateUserSubscriptionOutputSchema = z.object({
  success: z.boolean(),
