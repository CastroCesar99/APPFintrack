...
function SignupForm() {
    const { signUp, user: authUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$auth$2d$context$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])(); // authUser pode ser usado para pegar o usuário do auth
    ...
    async function onSubmit(values) {
        ...
        if (user) {
            try {
                ...
                toast({
                    ...
                    description: translate({
                        ...
                        pt: "Ocorreu um erro durante o cadastro. Por favor, tente novamente."
                    }),
                    variant: "destructive"
                });
            }
            ...
            toast({
                ...
                description: translate({
                    en: "Could not create your account. Email might already be in use.",
                    pt: "Não foi possível criar sua conta. O email já pode estar em uso."
                }),
                variant: "destructive"
            });
        }
