...
function BudgetsPage() {
    ...
    const currentMonthYearKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(displayedDate, 'yyyy-MM');
    const fetchPreferencesAndBudgets = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        ...
        try {
            ...
            if (prefsSnap.exists()) {
                ...
                if (effectiveCategories.length === 0 && __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CATEGORIES"].filter((cat)=>cat.type === 'expense').length > 0) {
        ...
        try {
            ...
            if (budgetSnap.exists()) {
                const budgetData = budgetSnap.data(); // Firestore stores numbers
    ...
    const handleReplicateToNextMonth = async ()=>{
        ...
        const budgetsToReplicate = Object.fromEntries(Object.entries(budgets).map(([key, value])=>{
            ...
            return [
                key,
                isNaN(numValue) || numValue <= 0 ? undefined : numValue
            ];
