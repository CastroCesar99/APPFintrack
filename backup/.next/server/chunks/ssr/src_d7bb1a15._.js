...
function TransactionForm({ onAddTransaction, initialType, defaultDate, userCategories = [], userPaymentMethods = [] // Default to empty array
 }) {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
        ...
        form.getValues,
        language
    ]); // form.setValue and form.getValues are stable
    ...
    const recurringLabel = translate({
        en: "Recurring",
        pt: "Recorrente"
    }); // Generic recurring for expenses
