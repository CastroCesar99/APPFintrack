                    ...
                    try {
                        ...
                        try {
                            ...
                            if (preferencesDocSnap.exists()) {
                                ...
                                const existingNames = new Set(allSystemCategories.map({
                                    "DashboardPage.useEffect.fetchDataInternal": (c)=>c.name.toLowerCase()
                                }["DashboardPage.useEffect.fetchDataInternal"]));
                                customCategoryDefs.forEach({
                                    "DashboardPage.useEffect.fetchDataInternal": (customCat)=>{
