(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_bb008535._.js", {
...
function IncomePage() {
    ...
    const fetchUserPreferences = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "IncomePage.useCallback[fetchUserPreferences]": async ()=>{
            if (!user) {
            ...
            try {
                ...
                if (preferencesDocSnap.exists()) {
                    ...
                    const finalUserCategoriesMap = new Map();
                    allSystemCategories.forEach({
                        "IncomePage.useCallback[fetchUserPreferences]": (cat)=>finalUserCategoriesMap.set(cat.name.toLowerCase(), cat)
                    }["IncomePage.useCallback[fetchUserPreferences]"]);
                    customCategoryDefs.forEach({
                        "IncomePage.useCallback[fetchUserPreferences]": (customCat)=>{
                    ...
                    basePaymentMethodsList.forEach({
                        "IncomePage.useCallback[fetchUserPreferences]": (pm)=>finalPaymentMethodsMap.set(pm.name.toLowerCase(), pm)
                    }["IncomePage.useCallback[fetchUserPreferences]"]);
                    customPaymentMethodDefs.forEach({
                        "IncomePage.useCallback[fetchUserPreferences]": (customPm)=>{
                    ...
                    if (selectedPaymentMethodNames.length > 0) {
                        const effectivePMs = Array.from(finalPaymentMethodsMap.values()).filter({
                            "IncomePage.useCallback[fetchUserPreferences].effectivePMs": (pm)=>selectedPaymentMethodNames.some({
                                    "IncomePage.useCallback[fetchUserPreferences].effectivePMs": (name)=>name.toLowerCase() === pm.name.toLowerCase()
                                }["IncomePage.useCallback[fetchUserPreferences].effectivePMs"])
                        }["IncomePage.useCallback[fetchUserPreferences].effectivePMs"]);
    ...
    const handleAddIncome = async (newTransactionData)=>{
        if (!user) {
            toast({
                title: translate({
                    en: "Error",
    ...
    const handleEditTransaction = (transactionId)=>{
        toast({
            ...
            description: `${translate({
                en: "Editing transaction",
                pt: "Editar transação"
            })} ID: ${transactionId} ${translate({
                en: "is coming soon.",
                pt: "está chegando em breve."
            })}`
        });
    };
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogContent"], {
                                ...
                                children: [
                                    ...
                                    }, displayedDate.toISOString() + "income" + userCategories.length + userPaymentMethods.length, false, {
                                        fileName: "[project]/src/app/income/page.tsx",
                                        lineNumber: 317,
                                        columnNumber: 13
                                    }, this)
...
_s(IncomePage, "lLvF5cM4JpQ3+mNYaJRXbmxu2Sc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
...
//# sourceMappingURL=src_bb008535._.js.map